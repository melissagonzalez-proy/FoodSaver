    ...
    <div className="min-h-screen bg-brand-background flex flex-col justify-center items-center p-4 font-sans relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-brand-card border border-brand-border rounded-4xl p-8 shadow-2xl z-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-brand-text font-jakarta">Nueva Contraseña</h1>
        ...
        {feedback.type !== 'success' ? (
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div className="relative">
              <label className="text-sm font-semibold text-brand-text mb-1.5 block">Nueva Contraseña</label>
              <div className="relative">
            ...
            <div className="relative">
              <label className="text-sm font-semibold text-brand-text mb-1.5 block">Confirmar Contraseña</label>
              <div className="relative">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-brand-muted" size={20} />
                <input
                  type="password"
